...
FAR_Player_Actions =
{
	if (alive player && player isKindOf "Man") then
	{
		...
		player addAction ["<t color=""#C90000"">" + "Revive" + "</t>", "FarRevive\FAR_handleAction.sqf", ["action_revive"], 10, true, true, "", "call FAR_Check_Revive"];
		player addAction ["<t color=""#C90000"">" + "Stabilize" + "</t>", "FarRevive\FAR_handleAction.sqf", ["action_stabilize"], 10, true, true, "", "call FAR_Check_Stabilize"];
		player addAction ["<t color=""#C90000"">" + "Suicide" + "</t>", "FarRevive\FAR_handleAction.sqf", ["action_suicide"], 9, false, true, "", "call FAR_Check_Suicide"];
		player addAction ["<t color=""#C90000"">" + "Drag" + "</t>", "FarRevive\FAR_handleAction.sqf", ["action_drag"], 9, false, true, "", "call FAR_Check_Dragging"];
	};
};
...
FAR_Drag =
{
	...
	_id = player addAction ["<t color=""#C90000"">" + "Release" + "</t>", "FarRevive\FAR_handleAction.sqf", ["action_release"], 10, true, true, "", "true"];
